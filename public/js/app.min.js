...
(function ($) {
  ...
  NJ.team_slider = function () {
    ...
    if ($team_slider_section.length) {
      ...
      $slider.on(
        "beforeChange",
        function (event, slick, current_slide, next_slide) {
  ...
  NJ.scroll_spy = function () {
    $(window).bind("scroll", function () {
      ...
      elems.each(function (index) {
        ...
        /* Hover menu item */
        if (
          window_top_position >= section_top_position &&
          window_top_position <= section_bottom_position
        ) {
          let id = $(this).attr("id");
        ...
        if (
          section_bottom_position >=
            window_top_position - scroll_to_top_button_offset &&
          section_top_position <=
            window_bottom_position + scroll_to_top_button_offset
        ) {
    ...
    if ($animated_sections.length) {
      ...
      let on_scroll_animation = function () {
        ...
        $animated_sections.each(function () {
          ...
          if (
            section_bottom_position >= window_top_position &&
  ...
  NJ.custom_cursor = {
    ...
    init: function () {
      this._cursor_follower_selector =
        document.getElementById("nj-cursor-follower");
      this._cursor_follower_selector.style.transform =
    ...
    setup_cursor: function () {
      ...
      // Color change
      document
        .querySelectorAll('[data-cursor-style="dark"]')
        .forEach(function (el) {
          el.addEventListener("mouseover", function () {
            self._cursor_follower_selector.classList.add(
              "nj-cursor-follower-dark"
            );
          });
          el.addEventListener("mouseout", function () {
            self._cursor_follower_selector.classList.remove(
              "nj-cursor-follower-dark"
            );
          });
        });
      ...
      // Hover effect
      document
        .querySelectorAll('[data-cursor-effect="hover"]')
        .forEach(function (el) {
          el.addEventListener("mouseover", function () {
            self._cursor_follower_selector.classList.add(
              "nj-cursor-follower-hover-effect"
            );
          });
          el.addEventListener("mouseout", function () {
            self._cursor_follower_selector.classList.remove(
      ...
      // Blend effect
      document
        .querySelectorAll('[data-cursor-effect="blend"]')
        .forEach(function (el) {
          el.addEventListener("mouseover", function () {
            self._cursor_follower_selector.classList.add(
              "nj-cursor-follower-blend-effect"
            );
          });
          el.addEventListener("mouseout", function () {
            self._cursor_follower_selector.classList.remove(
      ...
      // Exclusion effect
      document
        .querySelectorAll('[data-cursor-effect="exclusion"]')
        .forEach(function (el) {
          el.addEventListener("mouseover", function () {
            self._cursor_follower_selector.classList.add(
              "nj-cursor-follower-exclusion-effect"
            );
          });
          el.addEventListener("mouseout", function () {
            self._cursor_follower_selector.classList.remove(
    ...
    animate_cursor_follower: function () {
      let self = this;
      self._x +=
        (self.__x - self._x - self._cursor_follower_margin) /
        self._cursor_follower_delay;
      self._y +=
        (self.__y - self._y - self._cursor_follower_margin) /
        self._cursor_follower_delay;
