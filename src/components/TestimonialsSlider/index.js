...
//   let testimonials_arrow = testimonials
//     .parent()
//     .find(".nj-testimonials-slider-arrows");
        ...
        <div className="nj-testimonials-wrapper">
          <div className="nj-testimonials" id="nj-testimonials-slick">
            <div className="nj-testimonial">
              ...
              <div className="nj-client-testimonial">
                <p className="nj-client-testimonial-text">
                  Great, dedicated professional crew of people. It was my utmost
                  pleasure to take part in the podcast.
                </p>
              </div>
              <div
            ...
            <div className="nj-testimonial">
              ...
              <div className="nj-client-testimonial">
                <p className="nj-client-testimonial-text">
                  ...
                  chance to speak up and share what we do. High quality crew and
            ...
            <div className="nj-testimonial">
              ...
              <div className="nj-client-testimonial">
                <p className="nj-client-testimonial-text">
                  It was great how the interviewers were actually interested in
                  what guest had to say and asked great follow up questions.
                </p>
              </div>
              <div className="nj-client-name-wrapper">
                <p className="nj-client-name">
