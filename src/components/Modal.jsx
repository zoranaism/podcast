...
const InnerModal = (props) => {
    return (
        <div className="inner-modal">
            <button className='prev-btn' onClick={() => props.prev()}><FontAwesomeIcon icon={faChevronCircleLeft} /></button>
            <img src={props.image} alt="ras" />
            <button className='next-btn' onClick={() => props.next()}><FontAwesomeIcon icon={faChevronCircleRight} /></button>
        </div>
    )
}
