            ...
            <div className="row mb-5">
              <div className="col-12">
                ...
                <p className="nj-section-content" style={{ maxWidth: "900px" }}>
                  The Stellar Sound Podcast brings you inspiration by
                  interviewing the most creative, innovative, unique, eccentric,
                  and ground-breaking musicians from Europe.
                </p>
              </div>
            </div>
            <div className="row">
                      ...
                      <div className="nj-simple-card">
                        ...
                        <div className="nj-simple-card-text-wrapper">
                          ...
                          <p className="nj-simple-card-text">
                            There are many unknown and outstanding music
                            artists. By putting the spotlight on their craft in
                            our Podcast, we are promoting their work.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="nj-simple-card">
                        ...
                        <div className="nj-simple-card-text-wrapper">
                          ...
                          <p className="nj-simple-card-text">
                            If you are a music enthusiast, join our Stellar
                            Music Community Discord server.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div className="nj-simple-card">
                        ...
                        <div className="nj-simple-card-text-wrapper">
                          ...
                          <p className="nj-simple-card-text">
                            In these times it's not easy to keep up as a full
                            time musician. In that sense, we are organizing a
            ...
            <div className="nj-testimonials-wrapper">
              <div className="nj-testimonials" id="nj-testimonials-slick">
                <div className="nj-testimonial">
                  ...
                  <div className="nj-client-testimonial">
                    <p className="nj-client-testimonial-text">
                      ...
                      perfect, also the preparation work of the hosts, as well
                      how they lead the interviews.
                    </p>
                  </div>
                  <div
                ...
                <div className="nj-testimonial">
                  ...
                  <div className="nj-client-testimonial">
                    <p className="nj-client-testimonial-text">
                      I liked the voice of the interviewer very much. I also
                      liked when they were talking about real serious topics in
                      a so easy and relaxed manner.
                    </p>
                  </div>
              ...
              <div className="nj-testimonials-slider-arrows">
                <div
                  className="nj-testimonials-slider-next-arrow"
