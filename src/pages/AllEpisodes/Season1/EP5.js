...
export default function Episode5() {
  return (
    <EpisodeComponent
      ...
      description1='This is a fifth episode from the Stellar 1 Season. We are exploring songwriting with Milan, a songwriter, guitarist, and vocalist from the alternative rock band Ego.'
