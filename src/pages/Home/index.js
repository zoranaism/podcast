    ...
    <div>
      ...
      <div className="section nj-hero" id="nj-hero">
        ...
        <div className="section nj-dark-section" id="nj-community">
          <div className="container">
            <div className="nj-section-header">
              <h1 className="nj-section-header-title">
                Stellar Sound Community
              </h1>
            </div>
            <p>
              Our Discord Server gathers all music enthusiasts and music lovers
              to learn, share joy and love for creative music.
            </p>
            <br />
                  ...
                  <div className="col-lg-6 team">
                    <div className="team-text-wrapper">
                      <p className="nj-news-body-text">
                        ...
                        channeling strong passion through our work and having
                        fun in the process.
                      </p>
                    </div>
                ...
                <div className="nj-testimonial">
                  ...
                  <div className="nj-client-testimonial">
                    <p className="nj-client-testimonial-text">
                      ...
                      listened to some music podcasts where big bands were
                      guests. What I like about this podcast is that it gives
                      attention to smaller musicians.
                    </p>
                  </div>
                ...
                <div className="nj-testimonial">
                  ...
                  <div className="nj-client-testimonial">
                    <p className="nj-client-testimonial-text">
                      ...
                      wonderful space for independent musicians and giving us
                      the chance to speak up and share what we do. High quality
